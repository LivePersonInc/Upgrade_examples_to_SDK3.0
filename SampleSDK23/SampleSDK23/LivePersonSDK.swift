...
class LivePersonSDK : NSObject {
  ...
  public func showConversation(){
    ...
    if self.conversationQuery != nil {
      ...
      // FIXME : Needs to be remove after update to 2.7 or higher
      // Show Conversation
  ...
  public func showConversation(withView ViewController : UIViewController){
    ...
    if self.conversationQuery != nil {
      ...
      // FIXME : Needs to be remove after update to 2.7 or higher
      // Show Conversation
      LPMessagingSDK.instance.showConversation(self.conversationQuery!, authenticationCode: nil, containerViewController: ViewController)
    }
  }
  ...
  public func reconnect(){
    ...
    if self.conversationQuery != nil {
      ...
      // FIXME : Needs to be remove after update to 2.7 or higher
      // LPMessagingSDK Reconnect Mechanism
