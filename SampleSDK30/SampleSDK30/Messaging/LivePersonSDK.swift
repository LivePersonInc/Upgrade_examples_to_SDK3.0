...
class LivePersonSDK : NSObject {
  ...
  public func customizeMessagingScreen () {
    ...
    configuration.userBubbleErrorTextColor = UIColor.white
    // Set User - Error Bubble Border Color
    configuration.userBubbleErrorBorderColor = UIColor.red
    // Set User - Link Bubble Background Color
    configuration.userBubbleLinkColor = UIColor(red:0.29, green:0.51, blue:0.52, alpha:1.0)
    ...
    configuration.conversationNavigationTitleColor = UIColor.white
    // Set Conversation Status Bar Style
    configuration.conversationStatusBarStyle = .lightContent
    // Set Conversation Background Color
    configuration.conversationBackgroundColor = UIColor.white
    // INFO: Received Checkmark Options
